...
const products = [
    { id: 'INK-101', title: 'Atrament Czarny Klasyczny 50ml', price: 29.99, categoryId: '1', categoryName: 'Atramenty', icon: '\u{1F5A4}', sku: 'ATR-BLK-50B', image: 'images/INK-001.jpg', description: 'Klasyczny czarny atrament do kaligrafii. Doskonala plynnosc, gleboka czern. Idealny do codziennej pracy z piorem.' },
    { id: 'INK-102', title: 'Atrament Sepia Vintage 30ml', price: 34.99, categoryId: '1', categoryName: 'Atramenty', icon: '\u{1F90E}', sku: 'ATR-SEP-30B', image: 'images/INK-002.jpg', description: 'Atrament w kolorze sepii, inspirowany historycznymi dokumentami. Nadaje listom i kaligrafii antyczny charakter.' },
    { id: 'INK-103', title: 'Atrament Blekitny Niebo 50ml', price: 32.99, categoryId: '1', categoryName: 'Atramenty', icon: '\u{1F499}', sku: 'ATR-BLU-50B', image: 'images/INK-003.jpg', description: 'Delikatny blekitny atrament o subtelnym odcieniu nieba. Swietny do listow i zaprosen.' },
    { id: 'INK-104', title: 'Zestaw Atramentow 6 kolorow', price: 89.99, categoryId: '1', categoryName: 'Atramenty', icon: '\u{1F3A8}', sku: 'ATR-SET-6B', image: 'images/INK-004.jpg', description: 'Zestaw szesciu atramentow w roznych kolorach: czarny, sepia, blekitny, zielony, fioletowy, czerwony.' },
    { id: 'NIB-101', title: 'Stalowka Nikko G', price: 12.99, categoryId: '2', categoryName: 'Stalowki', icon: '\u{2712}\u{FE0F}', sku: 'NIB-NKG-01B', image: 'images/NIB-001.jpg', description: 'Popularna stalowka Nikko G, idealna dla poczatkujacych. Elastyczna i latwa w uzyciu.' },
    { id: 'NIB-102', title: 'Stalowka Brause Steno Blue Pumpkin', price: 8.99, categoryId: '2', categoryName: 'Stalowki', icon: '\u{2712}\u{FE0F}', sku: 'NIB-BRS-01B', image: 'images/NIB-002.jpg', description: 'Stalowka Brause o sredniej elastycznosci. Swietna do stylu italik i copperplate.' },
    { id: 'NIB-103', title: 'Stalowka Hunt 101', price: 14.99, categoryId: '2', categoryName: 'Stalowki', icon: '\u{2712}\u{FE0F}', sku: 'NIB-HNT-01B', image: 'images/NIB-003.jpg', description: 'Profesjonalna stalowka Hunt 101 z duzym zbiornikiem atramentu. Idealna do dlugich sesji kaligraficznych.' },
    { id: 'NIB-104', title: 'Zestaw stalowek 10 szt.', price: 49.99, categoryId: '2', categoryName: 'Stalowki', icon: '\u{2712}\u{FE0F}', sku: 'NIB-SET-10B', image: 'images/NIB-004.jpg', description: 'Zestaw dziesieciu roznych stalowek do kaligrafii. Zawiera stalowki pointed pen i broad edge.' },
    { id: 'PEN-101', title: 'Pioro Wieczne Lamy Safari', price: 149.99, categoryId: '3', categoryName: 'Piora wieczne', icon: '\u{1F58B}\u{FE0F}', sku: 'PEN-LAM-01B', image: 'images/PEN-001.jpg', description: 'Kultowe pioro wieczne Lamy Safari. Ergonomiczny chwyt, wymienne naboje. Dostepne w kolorze czarnym.' },
    { id: 'PEN-102', title: 'Pioro Wieczne Platinum Preppy', price: 39.99, categoryId: '3', categoryName: 'Piora wieczne', icon: '\u{1F58B}\u{FE0F}', sku: 'PEN-PLT-01B', image: 'images/PEN-002.jpg', description: 'Niedrogie pioro wieczne Platinum Preppy. Swietne dla poczatkujacych. Delikatna stalowka F.' },
    { id: 'PEN-103', title: 'Pioro Wieczne TWSBI Eco', price: 219.99, categoryId: '3', categoryName: 'Piora wieczne', icon: '\u{1F58B}\u{FE0F}', sku: 'PEN-TWS-01B', image: 'images/PEN-003.jpg', description: 'Pioro tlokowe TWSBI Eco z przezroczystym korpusem. Duzy zbiornik atramentu, plynne pisanie.' },
    { id: 'PEN-104', title: 'Pioro Wieczne Parker Sonnet', price: 459.99, categoryId: '3', categoryName: 'Piora wieczne', icon: '\u{1F58B}\u{FE0F}', sku: 'PEN-PRK-01B', image: 'images/PEN-004.jpg', description: 'Eleganckie pioro wieczne Parker Sonnet ze zlotym stalowka 18K. Idealny prezent dla milosnika pisania.' },
    { id: 'PAP-101', title: 'Blok do Kaligrafii A4 100 ark.', price: 44.99, categoryId: '4', categoryName: 'Papier i Pergaminy', icon: '\u{1F4C4}', sku: 'PAP-BLK-A4B', image: 'images/PAP-001.jpg', description: 'Blok papieru do kaligrafii formatu A4, 100 arkuszy. Gladka powierzchnia, gramatura 90g/m2.' },
    { id: 'PAP-102', title: 'Pergamin Naturalny A3', price: 19.99, categoryId: '4', categoryName: 'Papier i Pergaminy', icon: '\u{1F4DC}', sku: 'PAP-PRG-A3B', image: 'images/PAP-002.jpg', description: 'Autentyczny pergamin formatu A3. Naturalny kolor, idealna powierzchnia do kaligrafii.' },
    { id: 'PAP-103', title: 'Papier Bawelniany Kremowy 25 ark.', price: 54.99, categoryId: '4', categoryName: 'Papier i Pergaminy', icon: '\u{1F4C3}', sku: 'PAP-COT-25B', image: 'images/PAP-003.jpg', description: 'Luksusowy papier bawelniany w kolorze kremowym. 25 arkuszy, gramatura 120g/m2. Idealny do zaprosen.' },
    { id: 'PAP-104', title: 'Zwoj Pergaminu 5m', price: 79.99, categoryId: '4', categoryName: 'Papier i Pergaminy', icon: '\u{1F4DC}', sku: 'PAP-ZWJ-5MB', image: 'images/PAP-004.jpg', description: 'Zwoj pergaminu o dlugosci 5 metrow. Imitacja starozytnego pergaminu, idealny do dlugich projektow.' },
    { id: 'SET-101', title: 'Zestaw Startowy do Kaligrafii', price: 129.99, categoryId: '5', categoryName: 'Zestawy kaligraficzne', icon: '\u{1F381}', sku: 'SET-STR-01B', image: 'images/SET-001.jpg', description: 'Kompletny zestaw dla poczatkujacych: 3 stalowki, uchwyt, atrament czarny, blok A5. Idealny na prezent.' },
    { id: 'SET-102', title: 'Zestaw Profesjonalny Copperplate', price: 249.99, categoryId: '5', categoryName: 'Zestawy kaligraficzne', icon: '\u{1F381}', sku: 'SET-PRO-01B', image: 'images/SET-002.jpg', description: 'Zestaw profesjonalny do stylu copperplate: 5 stalowek, 2 uchwyty, 3 atramenty, papier premium.' },
    { id: 'SET-103', title: 'Zestaw Pioro + Atrament Gift Box', price: 189.99, categoryId: '5', categoryName: 'Zestawy kaligraficzne', icon: '\u{1F381}', sku: 'SET-GFT-01B', image: 'images/SET-003.jpg', description: 'Elegancki zestaw prezentowy: pioro wieczne i atrament w ozdobnym pudelku. Idealny prezent.' },
    { id: 'SET-104', title: 'Zestaw Brush Lettering', price: 99.99, categoryId: '5', categoryName: 'Zestawy kaligraficzne', icon: '\u{1F381}', sku: 'SET-BRL-01B', image: 'images/SET-004.jpg', description: 'Zestaw do brush letteringu: 6 brush penow, blok papieru, poradnik. Swietny na poczatek przygody z liternictwem.' }
];
